...
import { ledger, pureCircuits } from 'medical-contract/dist/managed/counter/contract/index.cjs';
  ...
  private constructor(
    ...
    this.state$ = combineLatest(
      ...
      (ledgerState, privateState) => {
        const hashedSecretKey = pureCircuits.publicKey(privateState.secretKey);
